...
| **Bluetooth** | NVDAF000 on UART3 | `btmrvl` (Marvell) | 🟡 Untested |
| **Audio** | Wolfson WM8962 | `snd-soc-wm8962` | ✅ Works |
| **HDMI Audio** | Tegra HDA | `snd-hda-tegra` | 🟡 Untested |
| **Touchscreen** | Atmel maXTouch mXT1664S | `atmel_mxt_ts` / `i2c-hid-of` | ✅ Works |
...
| **Sensors** | MSHW0102 HID sensor hub on I2C1 | `hid-sensor-hub` | ❓ Unknown |
...
| `NVDA0212` | SDM1 (SD slot) | 0x78000000 | — | PNP0D40 |
| `NVDA0212` | SDM2 (SDIO #2) | 0x78000200 | — | Purpose TBD |
| `NVDA0212` | SDM3 (Wi-Fi) | 0x78000400 | — | Marvell 88W8797 |
| `NVDA0212` | SDM4 (eMMC) | 0x78000600 | — | STOR.EMMC child |
...
| `NVDA0101` | I2C2 | 0x7000C400 | 116 | Audio codec |
| `NVDA0101` | I2C3 | 0x7000C500 | 124 | Misc peripherals |
| `NVDA0101` | I2C4 | 0x7000C700 | 152 | Misc peripherals |
...
| `NVDA0100` | UAR1–UAR5 | 0x70006000+ | — | 5 UARTs |
...
- **HID:** `NVDAF000`
- **Bus:** UART3 (0x70006200)
- **Driver:** Likely Marvell `btmrvl` (shared with 88W8797 combo chip)

### Sensor Hub — SNMU

- **HID:** `MSHW0102` (Microsoft Surface Hardware)
- **CID:** `PNP0C50` (HID-over-I2C)
- **Bus:** I2C1 @ address 0x28
...
- **USB2/USB3 HSIC:** Internal only — may connect to nothing useful on Surface 2 (no LTE modem). Can be ignored in DTS or force-disabled
- **xHCI:** Unreliable — avoid depending on it for daily use

---

## Thermal Zones

Four thermal zones defined in the SSDT:
...
|-----|---------|-----|---------|
| I2C1 | 0x7000C000 | 70 | Touchscreen (Atmel mXT1664S), Sensor hub (SNMU/MSHW0102 @ 0x28), SEN1 |
| I2C2 | 0x7000C400 | 116 | Audio codec (WM8962, likely @ 0x1A or 0x4B) |
| I2C3 | 0x7000C500 | 124 | Thermal sensors (TZ03/TZ04 `DHTH`), misc |
| I2C4 | 0x7000C700 | 152 | Misc peripherals |
